...
static esp_err_t GET_system_info(httpd_req_t * req)
{
    ...
    ESP_LOGI(TAG, "DEBUG: eth_available = %d, network_mode = %d",
             GLOBAL_STATE->ETHERNET_MODULE.eth_available,
             GLOBAL_STATE->ETHERNET_MODULE.network_mode);
...
esp_err_t start_rest_server(void * pvParameters)
{
    ...
    /* URI handler for Ethernet config */
    ...
    /* URI handler for network mode switching */
